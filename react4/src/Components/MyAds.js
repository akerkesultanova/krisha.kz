...
function MyAds(props) {
    ...
    async function loadData() {
      const bearer = "Bearer "+context.cookieJWT['jwt'].jwtToken;
      let response = await fetch("http://localhost:8000/api/myAds",{
        method:"GET",
...
if(data.length!=0){
    return (
        <div className="container">
          <h4><Icon style={{color:"black"}}>comment</Icon> My ads</h4>
          <hr></hr>
<div className="row">
    {data.map(favorite=>
    <div className="col s3">
<AdsEdit key={favorite.id} ad={favorite} change2={change2} setChange2={setChange2} />
        </div>
...
<div id="modal1" class="modal modal-fixed-footer">
  <form onSubmit={addAdSubmit}>
    ...
    <div class="modal-footer">
      ...
      <div className="row">
      <center>
      <Icon style={{fontSize:"500%",color:"#b71c1c"}}>block</Icon>
      <h3>You didn't add any ads</h3>
        </center>
